...
validatation_entry		valid_fields[] =
{
	...
	{ LAYER_DURATION,		N_("Layer duration in seconds"),			V_FLOAT_UNSIGNED,	V_NONE,		0,		300.0 },
	{ LAYER_HEIGHT,			N_("Height of this layer"),					V_INT_UNSIGNED,		V_NONE,		1,		4096 },
	{ LAYER_NAME,			N_("Name of this layer"),					V_CHAR,				V_COLON | V_FULL_STOP | V_HYPENS | V_SPACES | V_UNDERSCORES,					0,		20 },
	...
	{ LINE_WIDTH,			N_("Line width"),							V_FLOAT_UNSIGNED,	V_NONE,		0.05,	20 },
	...
	{ SLIDE_DURATION,		N_("Number of seconds in a slide"),			V_FLOAT_UNSIGNED,	V_NONE,		0.1,	300 },
	{ SLIDE_NAME,			N_("Name of this slide"),					V_CHAR,				V_HYPENS | V_SPACES | V_UNDERSCORES,					0,		20 },
	{ START_BEHAVIOUR, 		N_("Animation behavior after loading"),		V_CHAR,				V_UNDERSCORES,		0,		6 },
	{ TRANSITION_DURATION,	N_("Transition duration in seconds"),		V_FLOAT_UNSIGNED,	V_NONE,		0,		20 },
	...
	{ ZOOM_LEVEL,			N_("Magnification level of working area"),	V_ZOOM,				V_NONE,		0,		12 }
};
