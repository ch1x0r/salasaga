 ...
 * $Id$
 *
 * Flame Project: Function called when the x offset finish field in the timeline widget is edited 
 * 
...
void timeline_edited_x_offset_finish(GtkCellRendererText *selection, gchar *row, gchar *new_value, gpointer data)
{
	...
	switch (layer_data->object_type)
	{
		...
		case TYPE_GDK_PIXBUF:
			layer_data->x_offset_finish = atoi(new_value);
			break;
 ...
 * 
 * $Log$
 * Revision 1.7  2008/02/12 05:27:40  vapour
 ...
 *
 * Revision 1.4  2008/01/15 16:18:58  vapour
