...
void menu_export_layer(void)
{
	...
	return_code_gbool = gdk_pixbuf_save(GDK_PIXBUF(this_image_ob->image_data), filename, "png", NULL, "tEXt::Software", "The Flame Project: http://www.flameproject.org", NULL);
