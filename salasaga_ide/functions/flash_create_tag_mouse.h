...
#ifndef FLASH_CREATE_TAG_MOUSE_H_
#define FLASH_CREATE_TAG_MOUSE_H_
...
GByteArray *flash_create_tag_mouse(layer_image *layer_data);

#ifdef __cplusplus
}
#endif // __cplusplus

#endif /*FLASH_CREATE_TAG_MOUSE_H_*/
