...
gboolean display_dialog_highlight(layer *tmp_layer, gchar *dialog_title)
{
	...
	start_button = gtk_spin_button_new_with_range(valid_fields[FRAME_NUMBER].min_value, valid_fields[FRAME_NUMBER].max_value, 10);
	...
	finish_button = gtk_spin_button_new_with_range(valid_fields[FRAME_NUMBER].min_value, valid_fields[FRAME_NUMBER].max_value, 10);
