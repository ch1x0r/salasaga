...
validatation_entry		valid_fields[] =
{
	...
	{ PROJECT_VERSION,		"Version number of the project file",	V_FLOAT_UNSIGNED,	V_NONE,		0,		4.0 },
	...
	{ SLIDE_DURATION,		"Number of seconds in a slide",			V_FLOAT_UNSIGNED,	V_NONE,		0,		300 },
